(function() {
  module.exports = function(grunt) {
    var config, exec_sync, log_command, parse_operations, parse_variables, variables,
      _this = this;
    ...
    parse_operations = function(target_config) {
      var cmd, sub_cmd, sub_task, task, type, _i, _j, _k, _len, _len1, _len2;
